...
- **Frameworks & Libraries**: Flask, Next.js, React, Jinja2, scikit-learn, XGBoost
- **Databases & Data Tools**: MySQL, PostgreSQL, Drizzle ORM, database design, ETL pipelines
- **Software Engineering**: REST APIs, role-based access control, authentication, admin dashboards, testing, Git/GitHub
- **Analytics & ML Evaluation**: model evaluation, backtesting, walk-forward validation, data visualization
- **Tools and Platforms**: Docker, Streamlit, Plotly, Tableau, Power BI, MySQL Workbench, Vercel, Railway, DigitalOcean, LaTeX

## Technical Interests
- Full-stack software engineering
- Search and marketplace aggregation
- Data quality, parsing, and automation
